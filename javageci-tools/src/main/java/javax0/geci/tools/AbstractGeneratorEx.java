...
public abstract class AbstractGeneratorEx implements Generator {
    ...
    /**
     * Call the abstract method {@link #processEx(Source)} and catch any exception and rethrow it embedded into a
     * {@link GeciException}, which is a {@link RuntimeException}. That way the concrete implementation of
     * {@link #processEx(Source)} may just throw any {@link Exception}. Note that {@link Exception} is caught and not
     * {@link Throwable}.
     *
